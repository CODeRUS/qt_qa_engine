...
class IEnginePlatform : public QObject
{
    Q_OBJECT
public:
    explicit IEnginePlatform(QWindow* window);
    ...
    virtual void elementReply(ITransportClient* socket,
...
private slots:
    ...
    virtual void getElementRectCommand(ITransportClient* socket, const QString& elementId) = 0;
